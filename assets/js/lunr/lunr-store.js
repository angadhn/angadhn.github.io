var store = [{
        ...
        "excerpt":"⊕ Logo for SpaceHQ. We like to think of ourseleves as a ragtag group of outliers trying to figure out how we can build larger structures in space. An example challenge is how we can go from modular stations such as ISS, as seen on the left of our logo,...","categories": [],
        "tags": [],
        ...
        "excerpt":"Weblink Who might find the above link useful? The above online textbook is most useful for QMUL’s second year Aerospace Engineering undergraduate students taking EMS515U: Introduction to Spacecraft Dynamics. It could also be a useful resource for other educators interested in teaching orbital mechanics, especially using computational tools like numpy....","categories": [],
        "tags": [],
        "url": "/online_textbooks/spacecraft_dynamics/",
        "teaser": null
      },{
        "title": "Howler",
        "excerpt":"AIGrant Pitch Demo YCombinator The below is my proposal to Emergent Ventures 4 AI submitted in June 2022The proposal was not successful and reading it now, I can see why. But I think the app I built is still pretty cool, even if it is no longer on the App...","categories": ["Social Media","Grants"],
        "tags": [],
        "url": "/opinions/2024-09-28-Howler_EV4AI/",
        "teaser": null
      },{
        "title": "Some Space Stations in Fiction and Reality",
        "excerpt":"An earlier post in my teaching resources for a final year undergraduate project had a pretty helpful AI-generatedthanks to Claude table. This is a quick post about Wernher von Braun’s 1950’s conceptual rotating wheel station with some basic comparisons to the ISS (1998-present) and 1968’s Space Station V from 2001:...","categories": ["Large Space Stations","Space Exploration"],
        "tags": [],
        ...
        "excerpt":"Background Kepler’s SomniumAt the time of my writing this post, his sci-fi story was archived here in 1608 and Edward Everett Hale’s Brick Moon 1 from 1865 are early fantasy science-fiction of space-faring humans. Kepler faced more flak than fanfare for his workKepler’s mom was put on trial for witchcraft...","categories": ["Large Space Stations","Space Exploration"],
        "tags": [],
        "url": "/large%20space%20stations/space%20exploration/space-inflatables-1/",
        "teaser": null
      },{
